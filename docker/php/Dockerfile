...
#Añadido php.ini con la configuración de JIT
COPY php.ini /usr/local/etc/php/


#Añadidas varias configuraciones para el tratamiento de imágenes
COPY --from=composer /usr/bin/composer /usr/bin/composer

RUN apk add --update oniguruma-dev freetype-dev libpng-dev libjpeg-turbo-dev libxml2-dev autoconf g++ libtool make zip libzip-dev
...
RUN docker-php-ext-install zip mysqli gd pdo_mysql opcache
